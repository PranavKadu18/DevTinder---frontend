...
const Profile = () => {
  const currData = useSelector((state) => state.user.data);
    ...
    currData && (
      <div className="flex justify-center my-4">
        ...
        <div className="flex gap-6">
            ...
            <div className="card-body">
              ...
              <div className="mainholder gap-8 sm:flex">
                <div className="left">
                  ...
                  <label className="form-control w-full max-w-xs pb-2">
                    <div className="label">
                      <span className="label-text">Enter Your Gender</span>
                    </div>
                    <input
                      value={gender}
          ...
          <div>
            <h1 className="mb-8 text-xl">How Users Will See You</h1>
            <Card currUser={{firstName,lastName,age,bio,profilePhoto,gender}} />
          </div>
        </div>
      </div>
    )
